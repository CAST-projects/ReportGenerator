...
namespace CastReporting.Reporting.Block.Table
{
    ...
    class TechnoLoCEvolution : TableBlock
    {
        ...
        protected override TableDefinition Content(ReportData reportData, Dictionary<string, string> options)
        {
            ...
            rowData.AddRange(new string[] { "Name", "Current LOC", "Previous LOC", "Evolution", "% Evolution" });
            int nbLimitTop = 0;
            ...
            if (hasPrevious && null != reportData && null != reportData.CurrencySymbol)
            {
            ...
            if (hasPrevious && TechnologyResultPreviousSnapshot.Count() != TechnologyResultCurrentSnapshot.Count())
                {
