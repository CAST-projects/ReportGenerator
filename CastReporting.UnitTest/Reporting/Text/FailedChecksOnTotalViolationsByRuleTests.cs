...
{
    [TestClass]
    public class FailedChecksOnTotalViolationsByRuleTests
    {
        [TestInitialize()]
        ...
        public void TestContent()
        {
            ...
            var component = new FailedChecksOnTotalViolationsByRule();
            Dictionary<string, string> config = new Dictionary<string, string>
            {
                {"RULID", "1634" }
            };
            var str = component.Content(reportData, config);
            Assert.AreEqual("209 / 931", str);
        }
        [TestMethod]
        [DeploymentItem(@".\Data\cocraFuncWeight.json", "Data")]
        [DeploymentItem(@".\Data\RuleViolation1634.json", "Data")]
