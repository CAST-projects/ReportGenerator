...
{
    [TestClass]
    public class TrendComplianceTests
    {
        [TestInitialize()]
        ...
        public void TestOneSnapshot()
        {
            ...
            expectedData.AddRange(new List<string> { " ", "Prog.", "Arch.", "Doc.", "LoC" });
            expectedData.AddRange(new List<string> { "42756", "2.93", "2.1", "2.65", "21261" });
            expectedData.AddRange(new List<string> { "42756", "2.93", "2.1", "2.65", "21261" });
        ...
        public void TestTwoSnapshots()
        {
            ...
            var expectedData = new List<string>();
            expectedData.AddRange(new List<string> { " ", "Prog.", "Arch.", "Doc.", "LoC" });
            expectedData.AddRange(new List<string> { "42755", "2.91", "2.1", "2.47", "22347" });
            expectedData.AddRange(new List<string> { "42756", "2.93", "2.1", "2.65", "21261" });
            TestUtility.AssertTableContent(table, expectedData, 5, 3);
